...
func TestRegressionSplitTerminalUsage(t *testing.T) {
	...
	w := httptest.NewRecorder()
	p.streamBody(context.Background(), w, &wire, rec, false, false, &upstreamErrorRescue{})
	...
	pp.streamBody(context.Background(), pw, &pwire, prec, false, false, &upstreamErrorRescue{})
