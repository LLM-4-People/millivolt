...
func WriteYAML(w io.Writer, c *Config) error {
	...
	b.WriteString("# The shipped example enables Grok/Cursor compatibility profiles; built-in\n")
	b.WriteString("# defaults remain provider-neutral. Header versions are editable snapshots,\n")
	b.WriteString("# not verified provider contracts or privacy guarantees.\n")
	b.WriteString("#\n")
	b.WriteString("# Types:\n")
